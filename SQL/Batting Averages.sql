##https://www.codewars.com/kata/calculating-batting-average/train/sql/5c5313ee23252335e75721b5
...
SELECT player_name, games, CAST(ROUND(CAST(hits AS numeric(4,0))/CAST(at_bats AS numeric(4,0)), 3)  AS varchar(5)) AS  batting_average
FROM yankees
WHERE at_bats > 100
